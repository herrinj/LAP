...
x_re_FULL   = zeros(size(x_iters_FULL,2),1);
...
w_re_FULL   = zeros(size(w_iters_FULL,2),1);
...
figure();
hold on; axis tight;
semilogy(1:length(x_re_FULL), x_re_FULL,'-o');
...
figure();
hold on; axis tight;
semilogy(1:length(w_re_FULL), w_re_FULL,'-o');
